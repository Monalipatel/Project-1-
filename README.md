...
We download the data from [World Happiness Report 2019](https://worldhappiness.report/ed/2019/) and Clean data using pandas library in Python within a [Jupyter notebook: Data_Cleaning.ipynb](Data_Cleaning.ipynb)
